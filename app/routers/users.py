...
@router.post("/new", status_code=status.HTTP_201_CREATED, response_model=UserPublic)
...
def login(
    ...
    if user is None or not verify_pwd(user_credentials.password, user.password):
        raise HTTPException(
